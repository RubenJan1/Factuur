    ...
    if df.empty or df[required_cols].isna().all().any():
        ...
        try:
            ...
            if df["Total"].isna().any():
                ...
                bold_style = ParagraphStyle(name='Bold', parent=styles['Normal'], fontName='Helvetica-Bold', fontSize=10, leading=12)
                normal_style = ParagraphStyle(name='Normal', parent=styles['Normal'], fontSize=10, leading=12)
                footer_bold = ParagraphStyle(name='FooterBold', parent=styles['Normal'], fontName='Helvetica-Bold', fontSize=12, alignment=1)
                ...
                company_data = [
                    ...
                    [HRFlowable(width="50%", thickness=1, color=colors.black, hAlign='CENTER')],
